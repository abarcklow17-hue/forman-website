      ...
      <section className="relative pt-48 pb-32 border-b border-white/5 overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl space-y-8">
            <h4 className="text-primary font-bold uppercase tracking-wider text-sm">Our Capabilities</h4>
                ...
                <div className="flex-1 space-y-8">
                  ...
                  <ul className="space-y-4">
                    {['On-site Estimates', 'Same-day Service', 'Eco-friendly Disposal'].map((item, idx) => (
                      <li key={idx} className="flex items-center gap-3 text-sm font-semibold text-zinc-300">
